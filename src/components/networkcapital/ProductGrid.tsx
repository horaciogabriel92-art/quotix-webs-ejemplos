...
export default function ProductGrid() {
  ...
  return (
    <section id="productos" className="py-20 bg-[#007DB8]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {PRODUCTS.map((product, index) => (
            <motion.button
              ...
              className="group text-left bg-[#006BA3] rounded-2xl overflow-hidden border border-[#007DB8]/10 hover:border-[#F2B411]/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(0,125,184,0.15)]"
            ...
            >
              ...
              <div className="relative aspect-[4/3] overflow-hidden bg-white">
                ...
                <div className="absolute top-3 left-3">
                  <span className="px-3 py-1 bg-[#F2B411] text-[#003d5c] text-xs font-bold rounded-full uppercase">
                    {product.category}
                  </span>
                </div>
      ...
      <AnimatePresence>
        {selected && (
          ...
          >
            {/* Backdrop */}
            <motion.div
              className="absolute inset-0 bg-[#007DB8]/90 backdrop-blur-sm"
            ...
            {/* Card */}
            <motion.div
              className="relative w-full max-w-5xl max-h-[92vh] overflow-y-auto bg-[#006BA3] rounded-3xl border border-[#007DB8]/15 shadow-2xl"
            ...
            >
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-6 md:p-8 flex flex-col">
                      ...
                      {selected.colors.map((color, i) => (
                        <motion.button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all border ${
                            activeColor === color
                              ? "bg-[#F2B411] text-[#003d5c] border-[#F2B411]"
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selected.stampIdeas.map((idea, i) => (
                          <span
                            key={i}
                            className="px-3 py-1.5 bg-[#007DB8]/10 border border-[#007DB8]/20 rounded-lg text-[#007DB8] text-xs font-medium"
                          >
                            {idea}
                          </span>
                        ))}
                  ...
                  {/* Production note */}
                  <motion.div
                    className="mb-5 p-3 bg-[#007DB8]/10 border border-[#007DB8]/20 rounded-xl"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  >
                    <motion.a
                      ...
                      className="flex items-center justify-center gap-2 w-full px-6 py-4 bg-[#F2B411] text-[#003d5c] font-extrabold text-lg rounded-xl hover:bg-[#FFD700] transition-all shadow-[0_0_20px_rgba(242,180,17,0.2)]"
