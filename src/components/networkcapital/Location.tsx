...
export default function Location() {
  return (
    <section id="ubicacion" className="py-20 bg-[#0A0A0A] relative overflow-hidden">
      {/* Subtle grid texture */}
      <div
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Info card */}
          <div className="bg-[#0B1628] border border-white/5 rounded-3xl p-8 md:p-10">
          ...
          <div className="bg-[#0B1628] border border-white/5 rounded-3xl overflow-hidden min-h-[360px] relative">
            <iframe
